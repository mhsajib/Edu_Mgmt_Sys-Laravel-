    ...
    <div class="main_content">
      ...
      <h2 style="text-align: center; padding: 15px;"><u>ASSIGNMENT </u></h2>
         ...
         <form method="post"  enctype="multipart/form-data">
            ...
            <input type="text" id="fname" name="assignmentname" value="<?php echo e($user['assignmentname']); ?>">
            ...
            <input type="date" id="fname" name="updatedate" value="<?php echo e($user['updatedate']); ?>">
            ...
            <label for="fname">Assignment Filename</label>
            <input type="text" id="fname" name="assignmentfile" value="<?php echo e($user['assignmentfile']); ?>">
          
            <input type="submit" id = "fname" value="Update" style="background: #0078D7; border-radius: 12px">
           
          </form>

          <a href="<?php echo e(route('assignment.delete.index', $user['id'])); ?>"><input type="submit" id = "fname" value="Delete" style="background: #5BB55B; border-radius: 12px"></a>
...
</html><?php /**PATH F:\ATP3\Final\finalProject\lar\resources\views/assignment/edit.blade.php ENDPATH**/ ?>