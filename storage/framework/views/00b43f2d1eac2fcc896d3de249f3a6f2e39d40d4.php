...
<div class="wrapper">
    ...
    <div class="main_content">
        ...
        <div class="header" align="right"> 
            ...
            <button style="background-color: #7E99C5; padding: 12px 20px;border-radius: 8px;"><a href="/studentlistpdf/<?php echo e($list[0]->coursename); ?>" style="color: white">Print</a></button>
        </div>  
...
<?php /**PATH F:\ATP3\Final\finalProject\lar\resources\views/studentlist/index.blade.php ENDPATH**/ ?>