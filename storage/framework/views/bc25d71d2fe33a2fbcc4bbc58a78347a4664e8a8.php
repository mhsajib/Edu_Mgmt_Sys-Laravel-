    ...
    <div class="main_content">
      ...
      <h2 style="text-align: center; padding: 15px;"><u>ASSIGNMENT </u></h2>
         ...
         <form method="post"  enctype="multipart/form-data">
            ...
            <input type="submit" id = "fname" value="ADD" style="background: #4087C5;">
           
          </form>

          <a href="/assignment/edit"><input type="submit" id = "fname" value="Edit" style="background: #5BB55B;"></a>
...
</html><?php /**PATH F:\ATP3\Final\PROJECTfall_2019_20_laravel\lar\resources\views/assignment/index.blade.php ENDPATH**/ ?>