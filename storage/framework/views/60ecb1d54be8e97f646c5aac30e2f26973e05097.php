...
<?php $__currentLoopData = $note; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $std): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
      <td><?php echo e($std->notename); ?></td>
      <td><?php echo e($std->coursename); ?></td>
      <td><?php echo e($std->uploaddate); ?></td>
      <td><?php echo e($std->submissiondate); ?></td>
      <td><?php echo e($std->file); ?></td>
      <!-- <td><?php echo e($std->password); ?></td> -->
      <td>
         <button style="background-color: #7E99C5; padding: 12px 20px;border-radius: 8px;"> <a href="<?php echo e(route('note.edit', $std->id)); ?>" style="color: white">EDIT</a></button>
      </td>
    </tr>
...
</html><?php /**PATH F:\ATP3\Final\finalProject\lar\resources\views/notes/show.blade.php ENDPATH**/ ?>