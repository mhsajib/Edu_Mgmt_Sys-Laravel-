...
<?php $__currentLoopData = $faculty; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $std): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
      <td><?php echo e($std->facultyid); ?></td>
      <td><?php echo e($std->facultyname); ?></td>
      <td><?php echo e($std->dept); ?></td>
      <td><?php echo e($std->facultyemail); ?></td>
      <td><?php echo e($std->facultyaddress); ?></td>
...
</html><?php /**PATH F:\ATP3\Final\finalProject\lar\resources\views/faculty/index.blade.php ENDPATH**/ ?>