...
<div class="wrapper">
    ...
    <div class="main_content">
      ...
      <h2 style="text-align: center; padding: 15px;"><u>Notes</u></h2>

       <h2 style="color: blue; text-align: center; padding: 15px;">  <?php echo e(session('msg')); ?></h2>
         ...
         <form method="post"  enctype="multipart/form-data">
          <!--   <label for="fname">Assignment Name</label> -->
            ...
            <input type="text" id="fname" name="notename" placeholder="Name..">
<!-- 
        ...
        <!-- 
            ...
            <input type="date" id="fname" name="uploaddate" placeholder="Your last name..">
            ...
            <input type="file" id="fname" name="file" placeholder="Your last name..">
          
            <input type="submit" id = "fname" value="ADD" style="background: #0078D7; border-radius: 12px">
           
          </form>

          <a href="/notes/show"><input type="submit" id = "fname" value="Edit" style="background: #5BB55B; border-radius: 12px"></a>
...
</html><?php /**PATH F:\ATP3\Final\finalProject\lar\resources\views/notes/index.blade.php ENDPATH**/ ?>