...
<div class="wrapper">
 ...
 <!--    <% for(var i=0; i< user.length; i++){ %>
  ...
  <% } %> -->
         	...
         	<table style="width: 40%; text-align: center;" align="center" class="center" border="none">
          	<tr>
          		<td width="200px"><img src="/upload/ProfileImage.jpg" height="250px"></td>
              <td >
                <table width="100%" padding="10px">
                  <tr>
                    <td>User ID:</td>
                    <td><?php echo e($users->userId); ?></td>
                  </tr>
                  <tr>
                    <td>User Name:</td>
                   ...
                   <tr>
                    <td>Email:</td>
                    <td>mahmudul.sajib007@gmail.com</td>
                  </tr>
...
</html><?php /**PATH F:\ATP3\Final\finalProject\lar\resources\views/profile/index.blade.php ENDPATH**/ ?>