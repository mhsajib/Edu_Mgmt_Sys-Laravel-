...
<div class="wrapper">
    ...
    <div class="main_content"><br><br>

      <h1 style="text-align: center; padding: 15px;"><u>SYLLABUS </u></h1>

       <h2 style="color: blue;text-align: center;">  <?php echo e(session('msg')); ?></h2>
...
<!-- 
        ...
        <!-- 
          ...
          <a href="/syllabus/show"><input type="submit" id = "fname" value="Show/Edit" style="background: #5BB55B; border-radius: 12px"></a>
...
</html><?php /**PATH F:\ATP3\Final\finalProject\lar\resources\views/syllabus/index.blade.php ENDPATH**/ ?>