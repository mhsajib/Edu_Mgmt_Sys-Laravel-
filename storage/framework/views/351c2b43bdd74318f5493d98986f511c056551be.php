      ...
      <h2 style="text-align: center; padding: 15px;"><u>ASSIGNMENT </u></h2>
         ...
         <form method="post"  enctype="multipart/form-data">
           <!--  <label for="fname">Assignment Name</label>
            ...
            <input type="text" id="fname" name="assignmentfile" value="<?php echo e($user['file']); ?>">
          
            <input type="submit" id = "fname" value="Update" style="background: #0078D7; border-radius: 12px">
           
          </form>

          <a href="<?php echo e(route('syllabus.delete.index', $user['id'])); ?>"><input type="submit" id = "fname" value="Delete" style="background: #5BB55B; border-radius: 12px"></a>
...
</html><?php /**PATH F:\ATP3\Final\finalProject\lar\resources\views/syllabus/edit.blade.php ENDPATH**/ ?>