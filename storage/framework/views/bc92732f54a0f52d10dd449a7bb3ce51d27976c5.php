...
<?php $__currentLoopData = $syllabu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $std): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
      ...
      <td>
         <button style="background-color: #7E99C5; padding: 12px 20px;border-radius: 8px;"> <a href="<?php echo e(route('syllabus.edit', $std->id)); ?>">EDIT</a></button>
      </td>
    </tr>
...
</html><?php /**PATH F:\ATP3\Final\finalProject\lar\resources\views/syllabus/show.blade.php ENDPATH**/ ?>