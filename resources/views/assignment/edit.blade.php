    ...
    <div class="main_content">
      ...
      <h2 style="text-align: center; padding: 15px;"><u>ASSIGNMENT </u></h2>
         ...
         <form method="post"  enctype="multipart/form-data">
            ...
            <input type="text" id="fname" name="assignmentname" value="{{$user['assignmentname']}}">

            <label for="fname">Course Name</label>
            <input type="text" id="fname" name="coursename"value="{{$user['coursename']}}">
        
            <label for="fname">Upload Date</label>
            <input type="date" id="fname" name="updatedate" value="{{$user['updatedate']}}">
            ...
            <input type="date" id="fname" name="submissiondate" value="{{$user['submissiondate']}}">

            <label for="fname">Assignment Filename</label>
            <input type="text" id="fname" name="assignmentfile" value="{{$user['assignmentfile']}}">
          
            <input type="submit" id = "fname" value="Update" style="background: #0078D7; border-radius: 12px">
           
          </form>

          <a href="{{ route('assignment.delete.index', $user['id']) }}"><input type="submit" id = "fname" value="Delete" style="background: #5BB55B; border-radius: 12px"></a>
